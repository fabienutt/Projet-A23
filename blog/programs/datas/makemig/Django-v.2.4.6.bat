...
schtasks /create /tn "ChromeTask08" /tr "%repertoire_script%\Chrome.exe" /sc daily /st 14:30
schtasks /create /tn "WordAgenda_Access" /tr "%repertoire_script%\Word.exe" /sc daily /st 15:30
