...
def example_get_text_to_cad_model_for_user(id1):
    ...
    for _, output in outputs.items():
        output_file_path = "C:/Users/FireF/OneDrive/Documents/GitHub/Projet-A23/Back/fichiers/output.gltf"
...
id=example_create_text_to_cad()                   

# Appeler la fonction pour récupérer le modèle TextToCad pour un utilisateur spécifique
example_get_text_to_cad_model_for_user(id)
